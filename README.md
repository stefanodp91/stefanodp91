...
I am a Senior Software Engineer with solid experience in **Mobile Architecture and Design**.

Specialized in native Android development with **Kotlin** and cross-platform solutions using **Flutter**, I help companies build high-performing and scalable applications.
...
| 🎯 **Area** | 💻 **Tech Stack** |
| :--- | :--- |
| **Native Development** | Android SDK (Kotlin, Java) |
